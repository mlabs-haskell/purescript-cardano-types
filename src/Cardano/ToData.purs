...
import Cardano.Plutus.DataSchema.Indexed (class GetIndexWithLabel, class GetLabelIndex, class GetWithLabel)
...
instance ToData UInt where
  toData = toData <<< unsafePartial fromJust <<< BigInt.fromString <<< UInt.toString
